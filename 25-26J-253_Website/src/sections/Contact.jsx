    ...
    <section id="contact" className="section-bg">
      <Container>
        <div className="section-title" data-aos="fade-up">
          <h2>Contact Us</h2>
          <p>Get in touch with the PregAssist research team.</p>
        </div>
          ...
          <Col lg={5} data-aos="fade-right">
            <div className="info-box p-4 mb-4 rounded-4 shadow-sm bg-white hover-lift">
              <div className="d-flex align-items-center mb-3">
                <FaMapMarkerAlt className="me-3" color="#FF637E" size={24} />
            ...
            <div className="info-box p-4 mb-4 rounded-4 shadow-sm bg-white hover-lift">
              <div className="d-flex align-items-center mb-3">
                <FaEnvelope className="me-3" color="#51A2FF" size={24} />
            ...
            <div className="info-box p-4 rounded-4 shadow-sm bg-white hover-lift">
              <div className="d-flex align-items-center mb-3">
                <FaPhone className="me-3" color="#25D366" size={24} />
                ...
                <Row className="g-3">
                  ...
                  <Col md={12} className="text-center mt-4">
                    <Button 
                      ...
                      disabled={loading}
                      style={{ 
                        background: 'linear-gradient(135deg, #FF637E 0%, #FF8904 100%)', 
                        color: '#ffffff',
                        border: 'none', 
                        padding: '12px 40px', 
                        borderRadius: '50px',
