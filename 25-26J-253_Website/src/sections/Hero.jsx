...
import heroBg from '../assets/images/hero-bg.jpg'; // Make sure this image is updated to something medical/pregnancy related!
    ...
    <section id="hero" className="d-flex align-items-center" style={{
      ...
      <Container style={{ zIndex: '2', position: 'relative' }} className="text-center text-white" data-aos="zoom-in">
        ...
        <p style={{ 
          ...
          A comprehensive pregnancy support application for mothers and doctors. Synthesizing explainable fetal decision support, physical risk prediction, AI mental health monitoring, and AR-driven emergency training.
        </p>
